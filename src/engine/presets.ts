...
export const PIPE_PRESETS: Record<string, PipePreset> = {
  pnd32: { dInner: 26, c: 150, roughness: EPS_PLASTIC, label: 'ПНД 32 — внутр. Ø 26 мм' },
  ppr20: { dInner: 13, c: 150, roughness: EPS_PLASTIC, label: 'ППР 20 — внутр. Ø 13 мм' },
  ppr25: { dInner: 16.5, c: 150, roughness: EPS_PLASTIC, label: 'ППР 25 — внутр. Ø 16.5 мм' },
  ppr32: { dInner: 21, c: 150, roughness: EPS_PLASTIC, label: 'ППР 32 — внутр. Ø 21 мм' },
  steel12: { dInner: 12, c: 100, roughness: EPS_STEEL_OLD, label: 'Сталь ½" стара — внутр. Ø 12 мм' },
  steel34: { dInner: 20, c: 100, roughness: EPS_STEEL_OLD, label: 'Сталь ¾" стара — внутр. Ø 20 мм' },
  gi12: { dInner: 12, c: 120, roughness: EPS_GALVANIZED, label: 'Оцинковка ½" — внутр. Ø 12 мм' },
