...
<div class="card">
  ...
  <p class="lead">
    «Довжина» — це довжина труби, не глибина: вона впливає на тертя, а глибина до води —
    окремо, на підйом. Геометрію (розгалуження, підйоми) редагуватимеш на схемі-конструкторі — Етап 3.
  </p>
